 ...
 */
public class DialogResetGame extends Dialog{

    Context context;
    ListenerButton listenerButton;
    public DialogResetGame(Context context,ListenerButton listenerButton) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_reset_game);
