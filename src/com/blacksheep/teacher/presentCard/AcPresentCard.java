...
public class AcPresentCard extends Activity {
    ...
    public static String LOAD_ACTIVITY_BG = "LOAD_ACTIVITY_BG";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/TeachData/teachPresent.jpeg";
...
//        left_slide.setText("<");
    ...
    startActivity(Intent.createChooser(picMessageIntent, "Отправьте вашу открытку используя:"));*/
        final String mPath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/TeachData/teachPresent.jpeg";
        DialogSelectSocial dialogSelectSocial = new DialogSelectSocial(this, mPath);
        dialogSelectSocial.setClickListener(new DialogSelectSocial.ClickListener() {
            @Override
            public void click() {
                Intent intent = new Intent(AcPresentCard.this, AcPresentCardLoad.class);
                intent.putExtra(LOAD_ACTIVITY_BG, mPath);
