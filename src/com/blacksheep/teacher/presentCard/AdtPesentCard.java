...
public class AdtPesentCard extends BaseAdapter implements TitleProvider {
    ...
    private static final int VIEW_MAX_COUNT = VIEW21 + 1;
    ...
    private final String[] names = {"View1","View2","View3","View4","View5","View6","View7","View8","View9","View10","View11","View12","View13","View14","View15","View16","View17","View18","View19","View20","View21"};
...
//    private Bitmap decodeFile(int idRes){
//        //Decode image size
//        BitmapFactory.Options o = new BitmapFactory.Options();
//        o.inJustDecodeBounds = true;
//        //BitmapFactory.decodeStream(new FileInputStream(f),null,o);
//        BitmapFactory.decodeResource(Resources.getSystem(),idRes,o);
//
...
//        return BitmapFactory.decodeResource(Resources.getSystem(),idRes,o2);
//       // return null;
//    }
