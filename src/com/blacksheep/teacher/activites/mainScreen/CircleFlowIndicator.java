...
public class CircleFlowIndicator extends View implements FlowIndicator,
    ...
    public CircleFlowIndicator(Context context) {
        ...
        initColors(0x44FFFFFF, 0x44FFFFFF, STYLE_FILL, STYLE_STROKE);
    }
...
//                R.styleable.CircleFlowIndicator);
        ...
        int activeType = 1;//a.getInt(R.styleable.CircleFlowIndicator_activeType,
            //    STYLE_FILL);

        int activeDefaultColor = 0xFF646464;
...
//                inactiveDefaultColor);
        ...
        // Retrieve the radius
        radius = 8.0f;//a.getDimension(R.styleable.CircleFlowIndicator_radius, 4.0f);

        // Retrieve the fade out time
        fadeOutTime = 40000;//a.getInt(R.styleable.CircleFlowIndicator_fadeOut, 0);

        mCentered = false;//a.getBoolean(R.styleable.CircleFlowIndicator_centered, false);
